...
protected:
  ...
  bool fatal;          ///< Fatal exception will suddenly terminate the program.
  int exitCode;        ///< Exit code used if the exception is fatal.
  
  /**
   * The function handling the fatality attribute.
   */
